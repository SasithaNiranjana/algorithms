...
/**
 * The following algorithms demonstrate how to sort an array in ascending order using quick sort algorithm by optimizing the choosing the pivot point randomly
 *
